...
public protocol RecipeRepositoryProtocol {
    ...
    func putRecipeImagePaths(request: KikurageRecipeRequest, completion: @escaping (Result<Void, FirebaseClientError>) -> Void)
    func putRecipeImagePaths(request: KikurageRecipeRequest) -> Single<Void>
    /// 栽培記録を取得する
...
extension RecipeRepository {
    ...
    public func putRecipeImagePaths(request: KikurageRecipeRequest, completion: @escaping (Result<Void, FirebaseClientError>) -> Void) {
    ...
    public func putRecipeImagePaths(request: KikurageRecipeRequest) -> Single<Void> {
